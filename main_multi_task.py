...
if __name__ == '__main__':
    ...
    train_dir_path = '/nfs/trec_car/data/entity_ranking/multi_task_data_by_query_1000/test_data/'
    dev_dir_path = '/nfs/trec_car/data/entity_ranking/multi_task_data_by_query_1000//train_data/'
