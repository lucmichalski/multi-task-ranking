...
if __name__ == '__main__':
    ...
    train_and_dev_mutant(train_save_path_dataset=train_save_path_dataset, dev_save_path_dataset=dev_save_path_dataset, dev_save_path_run=dev_save_path_run, lr=0.0001, epoch=5, max_seq_len=16, batch_size=32)