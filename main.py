...
if __name__ == '__main__':
    ...
    run_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_tree_passage_train_data/benchmarkY1_tree_passage_train_100.run', '/nfs/trec_car/data/entity_ranking/benchmarkY1_tree_passage_dev_data/benchmarkY1_tree_passage_dev_100.run']
    qrels_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_tree_passage_train_data/benchmarkY1_tree_passage_train.qrels', '/nfs/trec_car/data/entity_ranking/benchmarkY1_tree_passage_dev_data/benchmarkY1_tree_passage_dev.qrels']
    topics_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_tree_passage_train_data/benchmarkY1_tree_passage_train.topics', '/nfs/trec_car/data/entity_ranking/benchmarkY1_tree_passage_dev_data/benchmarkY1_tree_passage_dev.topics']
    ...
    #
    # train_data_dir_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_toplevel_entity_train_data/benchmarkY1_toplevel_entity_train_para_250_chunks/'
    # train_batch_size = 8
    # dev_data_dir_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_toplevel_entity_dev_data/benchmarkY1_toplevel_entity_dev_para_250_chunks'
    # dev_batch_size = 128
    # dev_qrels_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_toplevel_entity_dev_data/benchmarkY1_toplevel_entity_dev.qrels'
    # dev_run_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_toplevel_entity_dev_data/benchmarkY1_toplevel_entity_dev_250.run'
    # model_path = None
    ...
    # experiment_name = 'benchmarkY1_toplevel_entity_para_250_lr_1e5_num_warmup_steps_100'
    # write = True
    # logging_steps = 100
    # head_flag = 'entity'
    #
