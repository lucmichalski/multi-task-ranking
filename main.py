...
#         processing.build_dataset(training_dataset=training_dataset, chuck_topic_size=100, first_para=True)
    ...
    train_data_dir_path = None #'/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_train_data/benchmarkY1_hierarchical_train_entity_synthetic_v2_300_chunks/'
    ...
    model_path = '/nfs/trec_car/data/bert_reranker_datasets/exp/benchmarkY1_hierarchical_entity_synthetic_v2_300_lr_5e6_num_warmup_steps_0.1_new_pipeline/epoch1_batch27000/'
    ...
    head_flag = 'entity'
    rerank_run_path = '/nfs/trec_car/data/entity_ranking/test_runs/benchmarkY1_hierarchical_entity_v2_300_test_Y2_automatic_entity.run'
