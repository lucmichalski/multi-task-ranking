...
if __name__ == '__main__':
    ...
    run_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_train_entity_100.run', '/nfs/trec_car/data/entity_ranking/benchmarkY1_dev_entity_100.run']
    qrels_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_train_entity.qrels', '/nfs/trec_car/data/entity_ranking/benchmarkY1_dev_entity.qrels']
    topics_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_train_entity.topics', '/nfs/trec_car/data/entity_ranking/benchmarkY1_dev_entity.topics']
    data_dir_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_train_entity_para_100_chunks/', '/nfs/trec_car/data/entity_ranking/benchmarkY1_dev_entity_para_100_chunks/']
    ...
    train_data_dir_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_train_entity_para_100_chunks/'
    train_batch_size = 8
    dev_data_dir_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_dev_entity_para_100_chunks/'
    dev_batch_size = 64
