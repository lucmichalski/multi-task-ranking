...
#     run_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_train_data/benchmarkY1_hierarchical_train_entity_synthetic_v2_300.run', '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_dev_data/benchmarkY1_hierarchical_dev_entity_synthetic_v2_300.run']
#     qrels_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_train_data/benchmarkY1_hierarchical_train_entity_synthetic_v2.qrels', '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_dev_data/benchmarkY1_hierarchical_dev_entity_synthetic_v2.qrels']
#     topics_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_train_data/benchmarkY1_hierarchical_train_entity_synthetic_v2.topics', '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_dev_data/benchmarkY1_hierarchical_dev_entity_synthetic_v2.topics']
#     data_dir_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_train_data/benchmarkY1_hierarchical_train_entity_synthetic_v2_300_chunks/', '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_dev_data/benchmarkY1_hierarchical_dev_entity_synthetic_v2_300_chuncks/']
...
#         processing.build_dataset(training_dataset=training_dataset, chuck_topic_size=100, first_para=True)
    ...
    train_data_dir_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_train_data/benchmarkY1_hierarchical_train_entity_synthetic_v2_300_chunks/'
    train_batch_size = 10
    ...
    experiment_name = 'benchmarkY1_hierarchical_entity_synthetic_v2_300_lr_5e6_num_warmup_steps_0.1_new_pipeline'
    write = True
    logging_steps = 1000
    head_flag = 'entity'
