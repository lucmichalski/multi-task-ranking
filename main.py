...
if __name__ == '__main__':
    ...
    run_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_train_data/benchmarkY1_train_entity_synthetic_300.run', '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_dev_data/benchmarkY1_dev_entity_synthetic_300.run']
    ...
    data_dir_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_train_data/benchmarkY1_train_entity_synthetic_300_chunks/', '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_dev_data/benchmarkY1_dev_entity_synthetic_300_chunks/']
    ...
    # train_data_dir_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_tree_entity_train_data/benchmarkY1_train_entity_tree_300_chunks/'
    # train_batch_size = 12
    # dev_data_dir_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_tree_entity_dev_data/benchmarkY1_dev_entity_tree_300_chunks/'
    # dev_batch_size = 64 * 8
    # dev_qrels_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_tree_entity_dev_data/benchmarkY1_dev_entity_tree.qrels'
    # dev_run_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_tree_entity_dev_data/benchmarkY1_dev_entity_tree_300.run'
    ...
    # experiment_name = 'benchmarkY1_tree_entity_300_lr_5e6_num_warmup_steps_0.1_new_pipeline'
    # write = True
    # logging_steps = 1000
    # head_flag = 'entity'
    #
