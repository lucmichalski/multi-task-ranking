...
if __name__ == '__main__':
    ...
    model_path = '/nfs/trec_car/data/bert_reranker_datasets/exp/benchmarkY1_hierarchical_synthetic_passage_100_lr_8e6_num_warmup_steps_0.1/epoch1_batch3000/'
    ...
    head_flag = 'entity'
    rerank_run_path = '/nfs/trec_car/data/entity_ranking/test_runs/benchmarkY1_hierarchical_entity_synthetic_100_test_Y2_automatic_entity.run'
