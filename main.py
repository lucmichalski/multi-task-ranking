...
if __name__ == '__main__':
    ...
    # }
    # max_length = 512
    # run_paths = ['/nfs/trec_car/data/entity_ranking/testY2_manual_entity_data/testY2_manual_entity_1000.run', '/nfs/trec_car/data/entity_ranking/testY2_automatic_entity_data/testY2_automatic_entity_1000.run']
    # qrels_paths = ['/nfs/trec_car/data/entity_ranking/testY2_manual_entity_data/testY2_manual_entity.qrels', '/nfs/trec_car/data/entity_ranking/testY2_automatic_entity_data/testY2_automatic_entity.qrels']
    # data_dir_paths = ['/nfs/trec_car/data/entity_ranking/testY2_manual_entity_data/testY2_manual_entity_1000_chunks/', '/nfs/trec_car/data/entity_ranking/testY2_automatic_entity_data/testY2_automatic_entity_1000_chunks/']
    # training_datasets = [False, False]
    # context_paths = ['/nfs/trec_car/data/entity_ranking/testY2_manual_entity_data/testY2_manual_entity_1000.run.context_with_special_tokens.json', '/nfs/trec_car/data/entity_ranking/testY2_automatic_entity_data/testY2_automatic_entity_1000.run.context_with_special_tokens.json']
    # hits = [1000, 1000]
