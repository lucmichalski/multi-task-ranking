...
if __name__ == '__main__':
    ...
    # }
    max_length = 512
    run_paths = ['/nfs/trec_car/data/entity_ranking/testY2_manual_entity_data/testY2_manual_entity_1000.run',
    ...
    qrels_paths = ['/nfs/trec_car/data/entity_ranking/testY2_manual_entity_data/testY2_manual_entity.qrels',
                   '/nfs/trec_car/data/entity_ranking/testY2_automatic_entity_data/testY2_automatic_entity.qrels',
                   '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_dev_data/benchmarkY1_dev_entity_synthetic.qrels',
                   '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_train_data/benchmarkY1_train_entity_synthetic.qrels']
    data_dir_paths = ['/nfs/trec_car/data/entity_ranking/testY2_manual_entity_data/testY2_manual_entity_1000_chunks_with_context_no_sep/',
                      '/nfs/trec_car/data/entity_ranking/testY2_automatic_entity_data/testY2_automatic_entity_1000_chunks_with_context_no_sep/',
                      '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_dev_data/benchmarkY1_dev_entity_synthetic_100_chunks_context_no_sep/',
                      '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_train_data/benchmarkY1_train_entity_synthetic_300_chunks_context_no_sep/']
    training_datasets = [False, False, False, True]
    context_paths = ['/nfs/trec_car/data/entity_ranking/testY2_manual_entity_data/testY2_manual_entity_1000.run.context.json',
                     '/nfs/trec_car/data/entity_ranking/testY2_automatic_entity_data/testY2_automatic_entity_1000.run.context.json',
                     '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_dev_data/benchmarkY1_dev_entity_synthetic_100.run.context.json',
                     '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_train_data/benchmarkY1_train_entity_synthetic_300.run.context.json']
    #hits = [1000, 1000]
    ...
    gpus = 6
    train_data_dir_path = data_dir_paths[3]
    ...
    experiment_name = 'bert_with_context_v2_no_sep_5e6_top5_ents'
    write = True
    logging_steps = 500
    head_flag = 'entity'
