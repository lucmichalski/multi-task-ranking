...
if __name__ == '__main__':
    ...
    run_paths = ['/nfs/trec_news_track/runs/anserini/bert/news_track.dev.bm25.500000.title+contents.50_words.run',
                 '/nfs/trec_news_track/runs/anserini/bert/news_track.train.bm25.500000.title+contents.50_words.run',
                 '/nfs/trec_news_track/runs/anserini/bert/news_track.test.bm25.500000.title+contents.50_words.run']
    ...
    # run_path = '/nfs/trec_news_track/runs/anserini/bert/news_track.dev.bm25.500000.title+contents.100_words.run'
    # index_path = NewsPassagePaths.index
    # car_index_path = CarEntityPaths.index
    # data_dir_path = '/nfs/trec_news_track/runs/anserini/bert/news_track_dev_bm25_500000_100_words_bert_chunks/'
    # max_length = 512
    # context_path = None
