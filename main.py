...
if __name__ == '__main__':
    ...
    model_path = '/nfs/trec_car/data/bert_reranker_datasets/exp/benchmarkY1_entity_100_lr_8e6_num_warmup_steps_2000_just_para/epoch3_batch2000/'
    ...
    head_flag = 'entity'
    rerank_run_path = '/nfs/trec_car/data/entity_ranking/test_runs/benchmarkY1_hierarchical_entity_old_100_test_Y2_automatic_entity.run'
