...
if __name__ == '__main__':
    ...
    # qrels_paths = ['/nfs/trec_car/data/entity_ranking/test_entity.qrels']
    # data_dir_paths = ['/nfs/trec_car/data/entity_ranking/test_hierarchical_entity_para_1000_chunks/']
    ...
    head_flag = 'entity'
    rerank_run_path = '/nfs/trec_car/data/entity_ranking/test_runs/benchmarkY1_entity_100_lr_8e6_num_warmup_steps_2000_just_para_dev.run'
