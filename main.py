...
if __name__ == '__main__':
    ...
    train_data_dir_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_train_passage_100_chucks/'
    train_batch_size = 8
    dev_data_dir_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_dev_passage_100_chucks/'
    dev_batch_size = 64
    ...
    experiment_name = 'benchmarkY1_passage_100_lr_8e6_num_warmup_steps_1000'
    write = True
    logging_steps = 1000
    head_flag = 'passage'
