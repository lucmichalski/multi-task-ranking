...
if __name__ == '__main__':
    ...
    # run_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_train_data/benchmarkY1_train_entity_synthetic_100.run', '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_dev_data/benchmarkY1_dev_entity_synthetic_100.run']
    ...
    # data_dir_paths = ['/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_train_data/benchmarkY1_train_entity_synthetic_100_chunks', '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_dev_data/benchmarkY1_dev_entity_synthetic_100_chunks']
    ...
    train_batch_size = 8
    dev_data_dir_path = '/nfs/trec_car/data/entity_ranking/benchmarkY1_hierarchical_entity_dev_data/benchmarkY1_dev_entity_synthetic_100_chunks/'
    dev_batch_size = 64 * 8
    ...
    experiment_name = 'benchmarkY1_hierarchical_synthetic_passage_100_lr_8e6_num_warmup_steps_0.1'
    write = True
    logging_steps = 1000
    head_flag = 'entity'
    ...
    # head_flag = 'entity'
    # rerank_run_path = '/nfs/trec_car/data/entity_ranking/test_runs/benchmarkY1_toplevel_entity_250_model_test_Y2_automatic_entity.run'
